...
const Plays = () => {
  return(
    ...
    <div className="flex flex-wrap">
      ...
      <div className="w-1/2 md:w-1/3 lg:w-1/4">
      <Poster
        src="https://in.bmscdn.com/discovery-catalog/events/tr:w-400,h-600,bg-CCCCCC:w-400.0,h-660.0,cm-pad_resize,bg-000000,fo-top:ote-U2F0LCAxNiBPY3Q%3D,ots-29,otc-FFFFFF,oy-612,ox-24/et00315141-bsnjyawgkl-portrait.jpg"
        title="Dum-Biryani- 16th Oct"
        subtitle="English ₹199"
      />
      </div>
      <div className="w-1/2 md:w-1/3 lg:w-1/4">
      <Poster
        src="https://in.bmscdn.com/discovery-catalog/events/tr:w-400,h-600,bg-CCCCCC:w-400.0,h-660.0,cm-pad_resize,bg-000000,fo-top:ote-RnJpLCA4IE9jdCBvbndhcmRz,ots-29,otc-FFFFFF,oy-612,ox-24:oi-discovery-catalog@@icons@@bundle-icon-shadow-4x.png,ox-15,oy-15,ow-50/et00315223-kyantwjbfn-portrait.jpg"
        title="The Body"
        subtitle="English ₹199"
      />
      </div>
      <div className="w-1/2 md:w-1/3 lg:w-1/4">
      <Poster className="w-1/2 md:w-1/3"
