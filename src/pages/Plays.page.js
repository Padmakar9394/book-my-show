...
const Plays = () => {
  return(
    ...
    <div className="hidden lg:block lg:w-1/4 mr-8">
        ...
        <button className="w-full p-1 mt-2 text-sm rounded-sm cursor-pointer border border-red-600 text-red-600 hover:text-gray-900 hover:border-gray-900">Browse by Venus</button>
       </div>
